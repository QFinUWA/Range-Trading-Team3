...
STD_DV = 3.5 # Number of Standard Deviations from the mean the Bollinger Bands sit
...
def preprocess_data(list_of_stocks):
    ...
    for stock in list_of_stocks:
        ...
        df['BOLU'] = df['MA-TP'] + STD_DV*df['std'] # Calculate Upper Bollinger Band
        df['BOLD'] = df['MA-TP'] - STD_DV*df['std'] # Calculate Lower Bollinger Band
...
# passing logic function as parameter. 
    ...
    print("standard deviations " + str(STD_DV))
